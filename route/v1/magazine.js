...
const CURRENT_SYSTEM_TYPE = "MAGAZINE";
...
app.put("/my-profile", async function (req, res) {
  ...
  const mgzn_pos_cd = isNull(req.body.mgzn_pos_cd, null);
  ...
  if ([user_nm, mgzn_pos_cd, phone_no].includes(null)) {
 ...
 *               type: array
 *               example: [ { "user_nm": "테스트", "mgzn_nm": "테스트매거진1", "dlvy_adres_nm": "송촌빌딩 13층", "dlvy_adres_no": "20210319000173", "adres_detail": "" }, { "user_nm": "테스트", "mgzn_nm": "테스트매거진1", "dlvy_adres_nm": "송촌빌딩 13층", "dlvy_adres_no": "20210319000171", "adres_detail": "" }, { "user_nm": "테스트", "mgzn_nm": "테스트매거진1", "dlvy_adres_nm": "송촌빌딩 13층", "dlvy_adres_no": "20210319000170", "adres_detail": "" }, { "user_nm": "테스트", "mgzn_nm": "테스트매거진1", "dlvy_adres_nm": "송촌빌딩 13층", "dlvy_adres_no": "20210319000169", "adres_detail": "" }, { "user_nm": "테스트", "mgzn_nm": "테스트매거진1", "dlvy_adres_nm": "송촌빌딩 13층", "dlvy_adres_no": "20210319000168", "adres_detail": "" } ]
 *             contact_info:
 *               description: "브랜드의 연락을 받을 수 있는 유저들의 정보."
 *               type: array
 *               example: [ { "user_id": "3a27da16-9b06-43a1-964e-70f70acf9806", "mgzn_user_nm": "김병수", "phone_no": "01043434343"} ]
 *             showroom_info:
 *               description: "선택한 쇼룸들의 정보. (showroom_list를 입력했을 시에만 출력)"
 *               type: array
...
app.post("/showroom-request", async function (req, res) {
  ...
  try {
    ...
    // //console.log(JSON.stringify(updateQuery));
    const selectResult_3 = await req.sequelize.query(selectQuery_3, {
      type: req.sequelize.QueryTypes.SELECT,
    });
    ...
    // //console.log(JSON.stringify(updateQuery));
    const selectResult_4 = await req.sequelize.query(selectQuery_4, {
      type: req.sequelize.QueryTypes.SELECT,
    });
...
app.post("/showroom-request-send", async function (req, res) {
  ...
  let photogrf_cntent = isNull(req.body.photogrf_concept, "") + "의 컨셉으로 촬영";
  if ( req.body.photogrf_concept ===  null ) {
    photogrf_cntent = "";
  }
  ...
  const req_user_id = isNull(req.body.req_user_id, null);
  let loc_yn = true;
  ...
  try {
    const selectQuery_1 = req.mybatisMapper.getStatement(
      ...
      "INSERT.REQUEST.001",
      {
        user_id : req_user_id != null ? req_user_id :  user_id ,
        brand_id,
        duty_recpt_dt,
        begin_dt,
        end_dt,
...
app.post("/sample-not-receive", async function (req, res) {
  const user_id = isNull(req.user_id, null);
  const mgzn_id = isNull(req.mgzn_id, null);
...
app.get("/my-info", async function (req, res) {
  ...
  try {
    ...
    res.json(
      Object.assign(selectResult_1[0], {
        success: true,
      })
    );
  } catch (error) {
 ...
 *               example: false
 */
app.post("/fav-show", async function (req, res) {
  const user_id = req.user_id;
  let brand_id = isNull(req.body.brand_id, null);
...
app.get("/pickup-schedule", async function (req, res) {
  ...
  try {
    ...
    const selectQuery = req.mybatisMapper.getStatement(
      ...
      { brand_id, start_date, fin_date, type: "SENDOUT", mgzn_id ,user_id},
      { language: "sql", indent: "  " }
    );
...
app.get("/sendout-schedule", async function (req, res) {
  ...
  try {
    const selectQuery = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { brand_id, start_date, fin_date, type: "RETURN", mgzn_id,user_id },
      { language: "sql", indent: "  " }
    );
...
app.get("/pickup-detailed/:date", async function (req, res) {
  ...
  try {
    ...
    const selectLeftQuery = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { mgzn_id,user_id, date, type: "SENDOUT",showroom_no : showroom_Array ,req_no_array : reqNo_Array },
      { language: "sql", indent: "  " }
    );
...
app.get("/pickup-detailed/req/:req_no", async function (req, res) {
  ...
  try {
    ...
    const selectLeftQuery = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { mgzn_id, user_id,req_no, type: "SENDOUT",showroom_no : showroom_Array.concat(showroom_no) },
      { language: "sql", indent: "  " }
    );
...
app.get("/sendout-detailed/:date", async function (req, res) {
  ...
  try {
    ...
    const selectLeftQuery = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { mgzn_id, user_id,date, type: "RETURN" ,showroom_no : showroom_Array},
      { language: "sql", indent: "  " }
    );
...
app.get("/sendout-detailed/req/:req_no", async function (req, res) {
  ...
  try {
    ...
    const selectLeftQuery = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { mgzn_id, user_id,req_no, type: "RETURN",showroom_no:showroom_Array.concat(showroom_no)},
      { language: "sql", indent: "  " }
    );
...
app.post("/pickup-success", async function (req, res) {
  const user_id = req.user_id;
  const req_no = req.body.req_no;
  const targetSampleList = isNull(req.body.targetSampleList, null);
  const mgzn_id = req.mgzn_id;
  try {
    const checkQuery = req.mybatisMapper.getStatement(
      "MAGAZINE",
      ...
      idresult.forEach( async(element) => {
        let selectQuery = req.mybatisMapper.getStatement(
          ...
          "UPDATE.PICKUP.SUCCESS.001",
          {
            user_id,
            req_no,
            sendout_userid : element.sendout_userid,
            targetSampleList
          },
          { language: "sql", indent: "  " }
        );
        let push_result = await req.sequelize.query(selectQuery, {
          type: req.sequelize.QueryTypes.SELECT,
        });
        await Promise.all(
          push_result.map((e) => {
            let token = e.token_value;
            delete e.token_value;
            req.sendMessage(token, e);
          })
        );
...
app.post("/showroom-request-update", async function (req, res) {
  ...
  const add_req_cntent = isNull(req.body.add_req_cntent, null);
  // dlvy_adres_no->배송주소
  const dlvy_adres_no = isNull(req.body.dlvy_adres_no, null);
  const dlvy_adres_nm = isNull(req.body.dlvy_adres_nm, null);
  const adres_detail = isNull(req.body.adres_detail, null);
  //dlvy_atent_matter용-> Shipping Notes
  const dlvy_atent_matter = isNull(req.body.dlvy_atent_matter, null);
  ...
  try {
    ...
    const updateQuery = req.mybatisMapper.getStatement(
      ...
      "UPDATE.REQUEST.001",
      {
        ...
        req_no,
        contact_user_id,
        req_user_id : req_user_id != null ? req_user_id : contact_user_id,
        begin_dt,
        end_dt,
        loc_value,
        loc_yn,
...
app.delete("/showroom-request-delete", async function (req, res) {
  ...
  try {
    const checkQuery = req.mybatisMapper.getStatement(
      "MAGAZINE",
      "CHECK.ACCESSABLE.REQ.MGZN.ARRAY",
      {
        req_list,
        mgzn_id,
      },
...
app.get("/home", async function (req, res) {
  ...
  try {
    ...
    /* const selectQueryold2 = req.mybatisMapper.getStatement(
      "MAGAZINE",
      "SELECT.HOME.002",
      {
        user_id,
    ...
    const selectResultold2 = await req.sequelize.query(selectQueryold2, {
      type: req.sequelize.QueryTypes.SELECT,
    }); */
    const selectQuery2 = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { date, type: "SENDOUT", mgzn_id,user_id },
      { language: "sql", indent: "  " }
    );
    const selectResult2 = await req.sequelize.query(selectQuery2, {
      type: req.sequelize.QueryTypes.SELECT,
    });
    const selectQuery2_2 = req.mybatisMapper.getStatement(
      "BRAND",
      "SELECT.SCHEDULE.LIST.MOBILE",
      { date, type: "RETURN", mgzn_id ,user_id},
      { language: "sql", indent: "  " }
    );
    const selectResult2_2 = await req.sequelize.query(selectQuery2_2, {
      type: req.sequelize.QueryTypes.SELECT,
    });
    const selectQuery3 = req.mybatisMapper.getStatement(
      "MAGAZINE",
    ...
    res.json({
      ...
      cnfirm_request_total_count: selectResult.length === 0 ? 0 : selectResult[0].total_count,
      today_request: selectResult2,
      today_sendout: selectResult2_2,
      today_request_total_count: selectResult2.length === 0 ? 0 : selectResult2[0].total_count,
      cnfirm_history: selectResult3.every((e) => e.count === 0) ? [] : selectResult3,
      pickup_history: selectResult4.every((e) => e.count === 0) ? [] : selectResult4,
...
app.get("/search/showroom", async function (req, res) {
  ...
  try {
    const showroomSelectQuery = req.mybatisMapper.getStatement(
      "MAGAZINE",
      "SELECT.SEARCH.SHOWROOM",
      { user_id, search_text, mgzn_id, limit, offset },
      { language: "sql", indent: "  " }
    );
    const showroomSelectResult = await req.sequelize.query(
      showroomSelectQuery,
      ...
      idresult.forEach( async(element) => {
        const insertQuery = req.mybatisMapper.getStatement(
          ...
          "UPDATE.SENDOUT.PUSH",
          {
            ...
            req_no,
            len,
            return_userid : element.return_userid,
            targetSampleList
          },
          { language: "sql", indent: "  " }
        );
...
app.post("/sendout-push-individual", async function (req, res) {
  ...
  const sample_no = isNull(req.body.sample_no, null);
  const req_no = isNull(req.body.req_no, null);
  const len = isNull(req.body.len, 1);
